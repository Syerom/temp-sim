...
PyObject *
_wrap_PyNs3SqliteDataOutput_GetTypeId(void)
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
    
    ns3::TypeId retval = ns3::SqliteDataOutput::GetTypeId();
    py_TypeId = PyObject_New(PyNs3TypeId, &PyNs3TypeId_Type);
    py_TypeId->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    py_TypeId->obj = new ns3::TypeId(retval);
    PyNs3TypeId_wrapper_registry[(void *) py_TypeId->obj] = (PyObject *) py_TypeId;
...
static PyMethodDef PyNs3SqliteDataOutput_methods[] = {
    ...
    {(char *) "GetTypeId", (PyCFunction) _wrap_PyNs3SqliteDataOutput_GetTypeId, METH_NOARGS|METH_STATIC, NULL },
